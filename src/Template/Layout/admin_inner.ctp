...
<head>
        ...
        <link rel="icon" href="<?php echo HTTP_ROOT.'img/uploads/site_favicon/'.$site_favicon; ?>" type="image/png" />
        ...
        <link rel="stylesheet" href="<?php echo HTTP_ROOT.'webroot/theme/bower_components/morris.js/morris.css'; ?>">
        <link rel="stylesheet" href="<?php echo HTTP_ROOT.'webroot/theme/bower_components/jvectormap/jquery-jvectormap.css'; ?>">
        <link rel="stylesheet" href="<?php echo HTTP_ROOT.'webroot/theme/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css'; ?>">
        <link rel="stylesheet" href="<?php echo HTTP_ROOT.'webroot/theme/bower_components/bootstrap-daterangepicker/daterangepicker.css'; ?>">
        <link rel="stylesheet" href="<?php echo HTTP_ROOT.'webroot/theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css'; ?>">
